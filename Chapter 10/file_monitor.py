...
# http://timgolden.me.uk/python/win32_how_to_do_i/watch_directory_for_changes.html
	...
	while 1:
		try:
			results = win32file.ReadDirectoryChangesW(
			  ...
			  1024,
			  True,
			  win32con.FILE_NOTIFY_CHANGE_FILE NAME | win32con.FILE_NOTIFY_CHANGE_DIR_NAME | win32con.FILE_NOTIFY_ATTRIBUTES | win32con.FILE_NOTIFY_CHANGE_SIZE | win32con.FILE_NOTIFY_CHANGE_LAST_WRITE | win32con.FILE_NOTIFY_CHANGE_SECURITY,
			  None,
			  None
			  )
...
for path in dirs_to_monitor:
	...
	print "Spawing monitoring thread for pathL %s" % path
