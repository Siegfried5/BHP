...
def server_loop(local_host,local_port,remote_host,remote_port,receive_first):
	...
	while True:
		...
		print "[+] Received incoming connection form %s:%d" %(addr[0],adrr[1])
...
def proxy_handler(client_socket, remote_host,remote_port, receive_first):
	...
	if receive_first:
		...
		# send it to our response_handler
	...
	while True:
		...
		if len(local_buffer):
			...
			# send it to ur request response_handler
		...
		# if no more dta on either side, close the connection
